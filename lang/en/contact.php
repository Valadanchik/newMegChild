...
return [
    ...
    'sale' => 'Sale',
    'sale_text' => 'If you are an author or a translator, if you have an already finished book or translation, then you can send an email to <pan> .</pan> In the subject section of the letter, indicate "Cooperation Offer". Sent a payer attached to the letter',
    'work' => 'Work',
    ...
    'partnership_text' => "To work with Newmag publishing house as a translator, editor, proofreader, you can send your CV to <span> $adminEmail/span> In the subject section of the letter, indicate 'CV'.",
