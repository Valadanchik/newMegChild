                ...
                <table border="0" width="600" cellpadding="0" cellspacing="0" align="center"
                    ...
                    <tr>
                        <th valign="top" style="mso-line-height-rule: exactly;">
                            ...
                            <table class="section_wrapper header" data-id="header" id="section-header" border="0"
                                   width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;"
                                        ...
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center"
                                            ...
                                            <tr>
                                                <th class="column_logo"
                                                    ...
                                                    <!-- Logo : BEGIN -->
                                                    <a href="https://danz.am/" target="_blank"
                                                       style="color: #c3c3c3; text-decoration: none !important; text-underline: none;">
                                                        <img
                                                            src="https://danz.am/assets/images/uploads/info-item-logo.png"
                            ...
                            <table class="section_wrapper main" data-id="main" id="section-main" border="0" width="100%"
                                   cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;"
                                   role="presentation" bgcolor="#ffffff">
                                <tbody>
                                <tr>
                                        ...
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center"
                                            ...
                                            <tr id="section-1468266" class="section heading">
                                                <th style="mso-line-height-rule: exactly; color: #4b4b4b; padding: 26px 52px 13px;"
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" width="100%"
                                                           role="presentation" style="color: #4b4b4b;"
                                                           bgcolor="#ffffff">
                                                        <tbody>
                                            ...
                                            <tr id="section-1468267" class="section introduction">
                                                <th style="mso-line-height-rule: exactly; padding: 13px 52px;"
                                                    ...
                                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;"
                                                       align="center">We'll sheep it out to you as soon as possible.</p>
                                                </th>
                                            </tr>
                                            ...
                                            <tr id="section-1468271" class="section products_with_pricing">
                                                ...
                                                <th style="mso-line-height-rule: exactly; padding: 13px 52px;"
                                                    bgcolor="#ffffff">
                                                    <table class="table-inner" cellspacing="0" cellpadding="0"
                                                           border="0" width="100%" style="min-width: 100%;"
                                                           role="presentation">
                                                        <tbody>
                                                        <tr>
                                                            <th class="product-table"
                                                                        ...
                                                                        <tr class="row-border-bottom">
                                                                            <th class="table-stack product-image-wrapper stack-column-center"
                                                                                ...
                                                                                <img width="140" class="product-image"
                                                                                     src="{{$variation->images->first() ? asset('variation_images/'.$variation->id.'/small/'.$variation->images->first()->path) : ''}}"
                                                                                     alt="Product Image"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <th class="line-item-description"
                                                                                            ...
                                                                                            <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                                                               align="left">
                                                                                                <a href="{{route('front.product.show',['sku' => $variation->sku])}}"
                                                                                                   target="_blank"
                                                                                                   style="color: #666363; text-decoration: none !important; text-underline: none; word-wrap: break-word; text-align: left !important; font-weight: bold;">
                                                                                                    {{ $variation->product->{'name_' . app()->getLocale()} . ' / ' . $variation->sku }}
                                                                                                </a>
                                                                                                <br>
                                                                                                <span class="muted"
                                                                ...
                                                                {{ $variation->color->{'name_' . app()->getLocale()} }}
                                                                  </span>
                                                                                            </p>
                                                                                        </th>
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" border="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th class="table-text"
                                                                            style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; width: 35%; padding: 6px 0;"
                                                                            align="right" bgcolor="#ffffff"
                                                                            valign="middle">{{$order->total_price_with_discount}}
                                                                            &nbsp; AMD
                                                                        </th>
                                                                    </tr>
                                            ...
                                            <tr id="section-1468272" class="section payment_info">
                                                <th style="mso-line-height-rule: exactly; padding: 13px 52px;"
                                                    ...
                                                    <table class="table-inner" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <th colspan="2" style="mso-line-height-rule: exactly;"
                                                                bgcolor="#ffffff" valign="top">
                                                                    ...
                                                                    <tr style="font-weight: bold;">
                                                                        <th width="40"
                                                                            ...
                                                                            <img width="40"
                                                                                 ...
                                                                                 alt="Mastercard Icon"
                                                                                 src="{{asset('payment_methods/'.$order->payment_method.'.png')}}">
                                                                        </th>
                                                                        <th style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: bold; color: #666363; padding: 8px 0;"
                                                                            ...
                                                                            @if($order->payment_method === \App\Models\Order::PAYMENT_METHOD_CASH)
                                                                                <span>Cash</span>
                                                                            @elseif($order->payment_method === \App\Models\Order::PAYMENT_METHOD_BANK)
                                                                                <span>Bank Card</span>
                                                    ...
                                                    <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th width="50%" class="column_1_of_2 column_bill_to "
                                                                style="mso-line-height-rule: exactly;" align="left"
                                                                bgcolor="#ffffff" valign="top">
                                                            ...
                                                            <th width="50%" class="column_2_of_2 column_ship_to "
                                                                style="mso-line-height-rule: exactly;" align="right"
                                                                bgcolor="#ffffff" valign="top">
                                                                <table align="center" border="0" width="100%"
                                                                       cellpadding="0" cellspacing="0"
                                                                       style="min-width: 100%;" role="presentation">
                                                                    ...
                                                                    <tr>
                                                                        <th style="mso-line-height-rule: exactly; padding-left: 5%;"
                                                                            ...
                                                                            <h3 data-key="1468273_ship_to"
                                                                                style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; color: #bdbdbd; font-size: 16px; line-height: 52px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; margin: 0;"
                                                                                align="right">Shipping Address</h3>
                                                                        </th>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        <th class="shipping_address "
                                                                            ...
                                                                            <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                                               align="right">
                                                                                {{$order->country->{'name_' . app()->getLocale()} }}
                                                                                <br>
                                                                                {{$order->region->{'name_' . app()->getLocale()} }}
                                                                                <br>
                                                                                {{$order->street}}<br>
                                                                            </p>
                                                                        </th>
                                            ...
                                            <tr id="section-1468276" class="section closing_text">
                                                <th data-key="1468276_closing_text" class="text"
                                                    ...
                                                    align="center" bgcolor="#ffffff">
                                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                       align="center">If you need help with anything please don't
                                                        hesitate to drop us an email: {{env('DANZ_EMAIL')}} :)</p>
                                                </th>
                                            </tr>
                                            ...
                                            <tr data-id="link-list">
                                                <td class="menu_bar menu_bar_6"
                                                    ...
                                                    bgcolor="#ffffff">
                                                    <table class="table_menu_bar" border="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <th class="menu_bar_item first"
                                                                ...
                                                                align="center" bgcolor="#ffffff">
                                                                <a href="{{route('front.main.privacy_policy')}}"
                                                                   target="_blank"
                                                            ...
                                                            <th class="menu_bar_item"
                                                                ...
                                                                align="center" bgcolor="#ffffff">
                                                                <a href="{{route('front.main.about')}}" target="_blank"
                                                                   style="color: #bdbdbd; text-decoration: none !important; text-underline: none; word-wrap: break-word; text-align: center !important; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; font-weight: 400; line-height: 26px; text-transform: uppercase; letter-spacing: 1px;">
                                                                    {{__('main.about_us')}}
                                                                </a>
                                                            </th>
                            ...
                            <table class="section_wrapper footer" data-id="footer" id="section-footer" border="0"
                                   width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;"
                                   role="presentation" bgcolor="#ffffff">
                                <tbody>
                                <tr>
                                    <td class="section_wrapper_th"
                                        style="mso-line-height-rule: exactly; padding: 0 52px;" bgcolor="#ffffff">
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center"
                                               style="min-width: 100%;" role="presentation">
                                                                ...
                                                                <table align="center" border="0" width="100%"
                                                                    ...
                                                                    <tr style="" align="center">
                                                                        <th class="column_shop_social_icons "
                                                                            ...
                                                                            <a class="social-link"
                                                                               href="https://www.instagram.com/danz.am/"
                                                                            ...
                                                                            <a class="social-link"
                                                                               href="https://www.youtube.com/channel/UCjTzLFW463QE6Z3yQmjoxfQ"
                                                                ...
                                                                <table align="center" border="0" width="100%"
                                                                    ...
                                                                    <tr style="" align="center">
                                                                        <th class="column_shop_block2 "
                                                                            data-key="section_shop_block2" width="100%"
                                                        ...
                                                        <tr>
                                                            <th class="column_shop_block1 " width="100%"
                                                                ...
                                                                <a href="https://danz.am/" target="_blank"
                                                                   ...
                                                                   style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; font-weight: 400; text-transform: none;">{{env('APP_NAME')}}</a>
                                                            </th>
                                                        </tr>
                                                        <!-- Store Website : END -->
                                                        </tbody>
